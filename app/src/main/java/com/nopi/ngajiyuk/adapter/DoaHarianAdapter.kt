package com.nopi.ngajiyuk.adapter
...
import kotlinx.android.synthetic.main.list_doa_harian.view.*

class DoaHarianAdapter(private val modelBacaan: List<ModelBacaan>) : RecyclerView.Adapter<DoaHarianAdapter.ListViewHolder>() {
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): ListViewHolder {
        val view = LayoutInflater.from(viewGroup.context).inflate(R.layout.list_doa_harian, viewGroup, false)
